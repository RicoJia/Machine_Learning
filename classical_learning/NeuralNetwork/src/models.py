...
class Dog_Classifier_Conv(nn.Module):
    ...
    def __init__(self, kernel_size, stride):
        ...
        self.conv1 = torch.nn.Conv2d(
            3, 16, kernel_size=kernel_size[0][0], stride=stride[0][0]
        )  # first two terms are: (input_channel, output channel)
        self.pool1 = torch.nn.MaxPool2d(kernel_size=2, stride=2)

        self.conv2 = torch.nn.Conv2d(
            16, 32, kernel_size=kernel_size[1][0], stride=stride[1][0]
        )
...
class Synth_Classifier(nn.Module):
    ...
    def __init__(self, kernel_size, stride):
        ...
        #        [(6, 3, 5, 5), (64, 16, 5, 5)]
        self.conv1 = torch.nn.Conv2d(
            1, 2, kernel_size=kernel_size[0][0], stride=stride[0][0]
        )  # first two terms are: (input_channel, output channel)
        self.pool1 = torch.nn.MaxPool2d(kernel_size=2, stride=2)

        self.conv2 = torch.nn.Conv2d(
            2, 4, kernel_size=kernel_size[1][0], stride=stride[1][0]
        )
        self.pool2 = torch.nn.MaxPool2d(kernel_size=2, stride=2)

        self.conv3 = torch.nn.Conv2d(
            4, 8, kernel_size=kernel_size[1][0], stride=stride[1][0]
        )
